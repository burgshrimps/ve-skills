# ve-skills — development notes

Internal working document: the contracts skills agree on, the ClawBio skill format,
and how the work was split. Kept out of the README so that page stays short.
